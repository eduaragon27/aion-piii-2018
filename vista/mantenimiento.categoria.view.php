        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar nueva Categoría</button>&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-9">
                                                <p>
                                                    Nombre Categoria <input type="text" 
                                                                  name="txtNombre" 
                                                                  id="txtNombre" 
                                                                  class="form-control input-sm text-bold">
                                                </p>
                                            ...
                                            <div class="col-xs-3">
                                                <p>
                                                    Requiere color?
                                                        <select name="cboColor" id="cboColor" class="form-control input-sm">
                                                            <option value="S">Si requiere</option> 
