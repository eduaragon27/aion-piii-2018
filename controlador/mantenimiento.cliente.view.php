        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar un nuevo articulo</button>&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                     ...
                                     <div class="row">
                                            <div class="col-xs-12">
                                                <p>
                                                    Telefono Movil1 <input type="text" 
                                      ...
                                      <div class="row">
                                            <div class="col-xs-12">
                                                <p>
                                                    Telefono Movil2 <input type="text" 
